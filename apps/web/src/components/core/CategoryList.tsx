...
import type { ITagCategory } from '@/lib/model/tag';
import type { ISavedFilterCategory } from '@/lib/model/savedFilter';
...
export function CategoryList(
  {
    ...
    title: string,
    data: ITagCategory[] | ISavedFilterCategory[],
    rowsPerPage: number,
    count: number, page: number,
    handleItemClick: (item: ITagCategory | ISavedFilterCategory) => void,
  ...
  function eachItem(itemKey: number, item: ITagCategory | ISavedFilterCategory): ReactNode {
...
export function SlimCategoryList(
  {
    title, data, count, page, onPageChange,
    rowsPerPage, onRowsPerPageChange,
    handleItemClick
