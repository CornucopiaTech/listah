...
return queryOptions({
  queryKey: ['ItemListing', userId, category, tags, id],
...
export default function ItemDetails(): React.ReactNode {
  ...
  const { isPending, isError, data, error }: UseQueryResult<IProtoItems> = useQuery(itemGroupOptions(userId, category, tags, itemId));
