...
func (a *filter) PrevRead(ctx context.Context, m *[]*model.Filter, s *model.ItemSearch) (int, error) {
...
func (a *filter) PrevUpsert(ctx context.Context, m interface{}, c *model.UpsertInfo) (interface{}, error) {
