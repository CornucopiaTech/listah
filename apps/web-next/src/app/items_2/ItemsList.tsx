...
async function getItems(userId: string, category: string | string [], tags: string[], pageNumber: number, recordsPerPage: number) {
...
export default function ItemsList(): React.ReactNode  {
  ...
  const items: IProtoItems | unknown = data.data.items;
  const totalRecords: number | unknown = data.data.totalRecordCount;
