...
type ItemServiceReadFilterResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Filters       []*Item                `protobuf:"bytes,1,rep,name=filters,proto3" json:"filters,omitempty"`
	Pagination    *Pagination            `protobuf:"bytes,502,opt,name=pagination,proto3" json:"pagination,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ItemServiceReadFilterResponse) GetFilters() []*Item {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *ItemServiceUpsertFilterRequest) GetFilters() []*Item {
	if x != nil {
		return x.Filters
	}
	return nil
...
const file_v1_item_proto_rawDesc = "" +
	...
	"\afilters\x18\x01 \x03(\v2\x0f.listah.v1.ItemR\afilters\x126\n" +
	"\n" +
	"pagination\x18\xf6\x03 \x01(\v2\x15.listah.v1.PaginationR\n" +
	"pagination\"K\n" +
	"\x1eItemServiceUpsertFilterRequest\x12)\n" +
	"\afilters\x18\x01 \x03(\v2\x0f.listah.v1.ItemR\afilters\"?\n" +
...
var file_v1_item_proto_depIdxs = []int32{
	...
	14, // 12: listah.v1.ItemServiceReadFilterResponse.filters:type_name -> listah.v1.Item
	16, // 13: listah.v1.ItemServiceReadFilterResponse.pagination:type_name -> listah.v1.Pagination
	14, // 14: listah.v1.ItemServiceUpsertFilterRequest.filters:type_name -> listah.v1.Item
