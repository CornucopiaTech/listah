...
func (a *itemAgent) Update(ctx context.Context, m []*model.RepoUpdate) error {
...
func (a *itemAgent) UpdateMany(ctx context.Context, m []*model.RepoUpdate) error {
...
func (a *itemAgent) Replace(ctx context.Context, m []*model.RepoReplace) error {
